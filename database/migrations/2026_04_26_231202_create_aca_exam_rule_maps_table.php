...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('aca_exam_rule_maps', function (Blueprint $table) {
            $table->id();
            $table->foreignId('exam_id')->constrained('aca_exams')->cascadeOnDelete();
            $table->foreignId('rule_id')->constrained('aca_exam_rules')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('aca_exam_rule_maps');
    }
};
