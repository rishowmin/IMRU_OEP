...
class TechExamSetController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('teacher.modules.aiExamSets.index', compact('examSets', 'topics', 'serialNo'));
    }
    ...
    public function create()
    {
        ...
        return view('teacher.modules.aiExamSets.form', compact('topics', 'questionStats'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()
                ->route('teacher.aiExamSets.show', $examSet)
    ...
    public function show(AcaExamSet $examSet)
    {
        ...
        $courseList = AcaCourse::where('teacher_id', auth()->id())
            ->whereNull('deleted_at')
            ->orderBy('course_title')
            ->get();

        return view('teacher.modules.aiExamSets.show', compact('examSet', 'questions', 'courseList'));
    }
    ...
    public function destroy(AcaExamSet $examSet)
    {
        $examSet->delete();
        return redirect()
            ->route('teacher.aiExamSets.index')
