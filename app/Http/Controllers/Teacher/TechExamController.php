...
class TechExamController extends Controller
{
    ...
    {
        $courseList = AcaCourse::orderBy('id', 'ASC')->where('teacher_id', auth()->id())->where('deleted_at', NULL)->get();
        return view('teacher.modules.exams.form', compact('courseList'));
    }
    ...
    public function store(ExamFormRequest $request)
    {
        try {
            ...
            return redirect()->route('teacher.exams.index')->with('success', 'Exam has been created successfully!');
    ...
    {
        $courseList = AcaCourse::orderBy('id', 'ASC')->where('teacher_id', auth()->id())->where('deleted_at', NULL)->get();
        return view('teacher.modules.exams.form', compact('exam', 'courseList'));
    }
    ...
    public function update(ExamFormRequest $request, AcaExam $exam)
    {
        try {
            ...
            return redirect()->route('teacher.exams.index')->with('success', 'Exam has been updated successfully!');
        } catch (\Throwable $exception) {
    ...
    public function examSettings(AcaExam $exam)
    {
        ...
        return view('teacher.modules.exams.exam_settings', compact('exam', 'allRules', 'mappedRuleIds'));
    }
    ...
    public function questionPaper(AcaExam $exam)
    {
        ...
        return view('teacher.modules.exams.question_paper', compact('exam', 'questionLibrary', 'serialNo'));
    }
    ...
    public function storeQuestion(QuestionFormRequest $request, AcaExam $exam)
    {
        try {
            ...
            return redirect()->route('teacher.exams.questionPaper', $exam->id)
    ...
    public function destroyQuestion(AcaExam $exam, AcaQuestion $question)
    {
        ...
        return redirect()
            ->route('teacher.exams.questionPaper', $exam->id)
