...
class TechPerformanceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('teacher.modules.performance.index', compact('exams'));
    }
    ...
    public function examAnalytics(AcaExam $exam)
    {
        ...
        return view('teacher.modules.performance.exam_analytics', compact(
            'exam',
            'gradeDistribution',
            'passFailData',
            'scoreDistribution',
    ...
    public function studentReport(AcaExam $exam, Student $student)
    {
        ...
        if (!$result) {
            return redirect()->route('teacher.performance.examAnalytics', $exam->id)
        ...
        return view('teacher.modules.performance.student_report', compact(
            'exam',
            'student',
            'result',
            'answers',
