...
class AcaCourseController extends Controller
{
    public function index()
    {
        ...
        return view('admin.academic.courses.index', compact('serialNo', 'courseList'));
    }
    ...
    public function store(CourseFormRequest $request)
    {
        try {
            ...
            return redirect()->route('admin.academic.courses.index')->with('success', 'Course has been created successfully!');
    ...
    public function update(CourseFormRequest $request, AcaCourse $course)
    {
        try {
            ...
            return redirect()->route('admin.academic.courses.index')->with('success', 'Course has been updated successfully!');
        } catch (\Throwable $exception) {
