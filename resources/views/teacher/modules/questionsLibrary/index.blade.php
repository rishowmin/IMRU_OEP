                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit">
                                                <a href="{{ route('teacher.questions.library.edit', $question->id) }}" class="btn btn-sm btn-outline-warning">
...
<script>
    $(document).on("click", ".deleteBtn", function() {
        ...
        let deleteRoute = "{{ route('teacher.questions.library.destroy', ['questionLib' => ':id']) }}";
