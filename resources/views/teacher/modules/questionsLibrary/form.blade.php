                        ...
                        <div class="card-header-left">
                            ...
                            <nav style="--bs-breadcrumb-divider: '•';">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item "><a href="{{ route('teacher.questions.library.index') }}">@yield('title')</a></li>
                                    <li class="breadcrumb-item active">{{ isset($questionLib) ? 'Edit' : 'Create' }} @yield('title2')</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="card-header-right">
                            <a href="{{ route('teacher.questions.library.index') }}" class="btn btn-outline-theme btn-sm">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapsecourse" class="accordion-collapse collapse show" aria-labelledby="headingcourse" data-bs-parent="#accordionAcademinCourses">
                        <div class="accordion-body">
                            ...
                            <form action="{{ isset($questionLib) ? route('teacher.questions.library.update', $questionLib->id) : route('teacher.questions.library.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
