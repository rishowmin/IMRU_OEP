                ...
                <div class="card mb-3">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="card-header-right">
                            <a href="{{ route('teacher.aiExamSets.create') }}" class="btn btn-sm btn-theme">
                                <i class="bi bi-stars"></i>
                                <span class="ms-1">Create @yield('title') by AI</span>
                            </a>
                            <a href="{{ route('teacher.exams.create') }}" class="btn btn-sm btn-outline-theme">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Settings">
                                                <a href="{{ route('teacher.exams.settings', $exam->id) }}" class="btn btn-sm btn-outline-dark">
                                                    <i class="bi bi-gear"></i>
                                                </a>
                                            </span>

                                            <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Question Paper">
                                                <a href="{{ route('teacher.exams.questionPaper', $exam->id) }}" class="btn btn-sm btn-outline-info">
                                                    <i class="bi bi-file-earmark-text"></i>
                                                </a>
                                            </span>

                                            <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit">
                                                <a href="{{ route('teacher.exams.edit', $exam->id) }}" class="btn btn-sm btn-outline-warning">
                                        ...
                                        <template class="child-template">
                                            <table class="table table-sm mb-0 w-100 small">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td width="8%" class="text-end"><i class="bi bi-arrow-return-right"></i></td>
                                                        <th width="22%">Total Questions</th>
                                                        <td width="70%">
...
<script>
    $(document).on("click", ".deleteBtn", function() {
        ...
        let deleteRoute = "{{ route('teacher.exams.destroy', ['exam' => ':id']) }}";
