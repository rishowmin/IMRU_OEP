                ...
                <div class="card mb-3">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="card-header-right">
                            <a href="{{ route('teacher.enrollments.index') }}" class="btn btn-sm btn-outline-theme">
...
@include('teacher.layouts.common.deleteBulkModal')
...
<script>
    $(document).on("click", ".deleteBtn", function () {
        ...
        const deleteRoute = "{{ route('teacher.enrollments.destroy', ['enroll' => ':id']) }}";
...
<script>
    $(document).on("click", ".deleteCourseBtn", function () {
        ...
        const deleteRoute = "{{ route('teacher.enrollments.destroyCourse', ['course' => ':id']) }}";
