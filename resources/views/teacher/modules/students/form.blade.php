                        ...
                        <div class="card-header-left">
                            ...
                            <nav style="--bs-breadcrumb-divider: '•';">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item "><a href="{{ route('teacher.students.index') }}">@yield('title')</a></li>
                                    <li class="breadcrumb-item active">{{ isset($student) ? 'Edit' : 'Create' }} @yield('title2')</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="card-header-right">
                            <a href="{{ route('teacher.students.index') }}" class="btn btn-outline-theme btn-sm">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapsecourse" class="accordion-collapse collapse show" aria-labelledby="headingcourse" data-bs-parent="#accordionAcademinCourses">
                        <div class="accordion-body">
                            ...
                            <form action="{{ isset($student) ? route('teacher.students.update', $student->id) : route('teacher.students.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @if(isset($student))
                                @method('PUT')
                                @endif
