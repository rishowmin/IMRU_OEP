                ...
                <div class="card mb-3">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="card-header-right">
                            <a href="{{ route('teacher.students.create') }}" class="btn btn-sm btn-outline-theme">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Profile">
                                                <a href="{{ route('teacher.students.profile', $student->id) }}" class="btn btn-sm btn-outline-info">
...
<script>
    $(document).on("click", ".deleteBtn", function() {
        ...
        let deleteRoute = "{{ route('teacher.students.destroy', ['student' => ':id']) }}";
