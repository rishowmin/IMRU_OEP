                ...
                <div class="card mb-3">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="card-header-right">
                            <a href="{{ route('teacher.questions.create') }}" class="btn btn-sm btn-outline-theme">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit">
                                                <a href="{{ route('teacher.questions.edit', $question->id) }}" class="btn btn-sm btn-outline-warning">
...
<script>
    $(document).on("click", ".deleteBtn", function() {
        ...
        let deleteRoute = "{{ route('teacher.questions.destroy', ['question' => ':id']) }}";
