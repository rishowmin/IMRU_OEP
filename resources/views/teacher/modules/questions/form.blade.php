                        ...
                        <div class="card-header-left">
                            ...
                            <nav style="--bs-breadcrumb-divider: '•';">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item "><a href="{{ route('teacher.questions.index') }}">@yield('title')</a></li>
                                    <li class="breadcrumb-item active">{{ isset($question) ? 'Edit' : 'Create' }} @yield('title2')</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="card-header-right">
                            <a href="{{ route('teacher.questions.index') }}" class="btn btn-outline-theme btn-sm">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapsecourse" class="accordion-collapse collapse show" aria-labelledby="headingcourse" data-bs-parent="#accordionAcademinCourses">
                        <div class="accordion-body">
                            ...
                            <form action="{{ isset($question) ? route('teacher.questions.update', $question->id) : route('teacher.questions.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @if(isset($question))
                                @method('PUT')
                                @endif
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="figure-preview mt-3">
                                                    ...
                                                    <div class="p-2 border rounded">
                                                        <img id="figure_preview_img" src="{{ asset('assets/storage/question_figure/' . $question->question_figure) }}" alt="Question Figure" class="img-fluid" style="width:100%; max-height: 200px">
                                                    </div>
                                                    @else
                                                    <div class="p-2 border rounded">
