...
<section class="section">
    ...
    <form action="{{ route('teacher.myProfile.store', $teacher->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-body text-center">
                        <div class="profile-photo mb-3 position-relative d-inline-block" onclick="document.getElementById('profile_photo_input').click()">
                            ...
                            {{-- Preview image --}}
                            <img id="photo-preview" src="{{ $info?->profile_photo ? asset('assets/storage/profile_photo/teacher/' . $info->profile_photo) : '' }}" alt="Profile Photo" class="rounded-circle object-fit-cover border" style="{{ $info?->profile_photo ? '' : 'display:none;' }}">
