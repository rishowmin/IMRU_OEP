                        ...
                        <div class="card-header-left">
                            ...
                            <nav style="--bs-breadcrumb-divider: '•';">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('teacher.reviewAnswer.index') }}">@yield('title')</a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('teacher.reviewAnswer.show', $exam->id) }}">Students</a></li>
                                    <li class="breadcrumb-item active">@yield('title2')</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="card-header-right">
                            <a href="{{ route('teacher.reviewAnswer.show', $exam->id) }}" class="btn btn-outline-theme btn-sm">
...
<section class="section">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <form method="POST" action="{{ route('teacher.reviewAnswer.store', [$exam->id, $student->id]) }}">
                @csrf
