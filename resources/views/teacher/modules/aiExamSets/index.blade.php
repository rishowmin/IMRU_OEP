                ...
                <div class="card mb-3">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="card-header-right">
                            <a href="{{ route('teacher.aiExamSets.create') }}" class="btn btn-sm btn-outline-theme">
                                <i class="bi bi-stars"></i>
                            ...
                            <table class="table table-sm small" id="generateExamByAiTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{-- <a href="{{ route('teacher.aiExamSets.show', $set) }}" class="btn btn-sm btn-outline-primary">View</a> --}}

                                            <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="View">
                                                <a href="{{ route('teacher.aiExamSets.show', $set) }}" class="btn btn-sm btn-outline-info">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                            </span>
...
<script>
    $(document).on("click", ".deleteBtn", function() {
        ...
        let deleteRoute = "{{ route('teacher.aiExamSets.destroy', ['examSet' => ':id']) }}";
