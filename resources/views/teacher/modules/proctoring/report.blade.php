                ...
                <div class="card mb-3">
                    <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <nav style="--bs-breadcrumb-divider: '•';">
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item">
                                        <a href="{{ route('teacher.dashboard') }}"><i class="bi bi-house"></i></a>
                                    </li>
                                    <li class="breadcrumb-item">
                                        <a href="{{ route('teacher.proctoring.index') }}">Proctoring</a>
                                    </li>
                        ...
                        <div class="card-header-right">
                            <a href="{{ route('teacher.proctoring.index') }}" class="btn btn-sm btn-outline-secondary">
