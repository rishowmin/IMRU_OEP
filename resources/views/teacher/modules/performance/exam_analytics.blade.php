                        ...
                        <div class="card-header-left">
                            ...
                            <nav style="--bs-breadcrumb-divider: '•';">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('teacher.performance.index') }}">Performance</a></li>
                                    <li class="breadcrumb-item active">@yield('title')</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="card-header-right">
                            <a href="{{ route('teacher.performance.index') }}" class="btn btn-outline-theme btn-sm">
                            ...
                            <tr class="{{ $rowClass }}">
                                ...
                                <td>
                                    <div class="d-flex align-items-center justify-content-center gap-1">
                                        ...
                                        <a href="{{ route('teacher.reviewAnswer.studentAnswers', [$exam->id, $result->student_id]) }}" class="btn btn-xs btn-outline-theme btn-sm" title="Review Answer" target="_blank">
                                            <i class="bi bi-pencil-square"></i>
                                        </a>
                                        @endif
                                        <a href="{{ route('teacher.performance.studentReport', [$exam->id, $result->student_id]) }}" class="btn btn-xs btn-outline-primary btn-sm" title="View Result">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    </div>
                                </td>
