                        ...
                        <div class="card-header-left">
                            ...
                            <nav style="--bs-breadcrumb-divider: '•';">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('teacher.performance.examAnalytics', $exam->id) }}">Exam Analytics</a></li>
                                    <li class="breadcrumb-item active">@yield('title')</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="card-header-right">
                            <a href="{{ route('teacher.performance.examAnalytics', $exam->id) }}" class="btn btn-outline-theme btn-sm">
