                        ...
                        <div class="card-header-left">
                            ...
                            <nav style="--bs-breadcrumb-divider: '•';">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active">{{ isset($teacher) ? 'Edit' : 'Add' }} @yield('title2')</li>
                                </ol>
                            </nav>
                        </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingcourse">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapsecourse" aria-expanded="true" aria-controls="collapsecourse">
                            <h6 class="card-title p-0 m-0">
                                ...
                                {{ isset($teacher) ? 'Update' : 'Create A New' }} @yield('title2')
                            </h6>
                        </button>
                    </h2>
                    <div id="collapsecourse" class="accordion-collapse collapse show" aria-labelledby="headingcourse" data-bs-parent="#accordionAcademinCourses">
                        <div class="accordion-body">
                            ...
                            <form action="{{ isset($teacher) ? route('admin.academic.teachers.update', $teacher->id) : route('admin.academic.teachers.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @if(isset($teacher))
                                @method('PUT')
                                @endif
                                @php
                                $isActive = old('is_active', isset($teacher) ? $teacher->is_active : 1);
                                @endphp
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row align-items-baseline mb-2">
                                            <label for="first_name" class="col-sm-3 col-form-label fw-bold"><small>Teacher Name</small> <small class="text-danger">*</small></label>
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Teacher's First & Last Name"><i class="bi bi-info-circle"></i></span>
                                                    <input type="text" id="first_name" class="form-control @error('first_name') is-invalid @elseif(old('first_name', $teacher->first_name ?? false)) is-valid @enderror" name="first_name" value="{{ old('first_name', $teacher->first_name ?? '') }}" placeholder="First Name">

                                                    <input type="text" id="last_name" class="form-control @error('last_name') is-invalid @elseif(old('last_name', $teacher->last_name ?? false)) is-valid @enderror" name="last_name" value="{{ old('last_name', $teacher->last_name ?? '') }}" placeholder="Last Name">
                                                </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    @if(old('first_name', $teacher->first_name ?? false) && old('last_name', $teacher->last_name ?? false))
                                        ...
                                        <div class="row align-items-baseline mb-2">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" id="email" class="form-control @error('email') is-invalid @elseif(old('email', $teacher->email ?? false)) is-valid @enderror" name="email" value="{{ old('email', $teacher->email ?? '') }}" placeholder="Email">
                                                </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    @else
                                                    @if(old('email', $teacher->email ?? false))
                                                    <div class="valid-feedback d-block">
                                                        <i class="bi bi-check-circle"></i>
                                                        Looks good!
                                                    </div>
                                        ...
                                        {{-- Password --}}
                                        <div class="row align-items-baseline mb-2">
                                            <label for="password" class="col-sm-3 col-form-label fw-bold"><small>{{ isset($teacher) ? 'Update Password' : 'Password' }}</small> <small class="text-danger">{{ isset($teacher) ? '' : '*' }}</small></label>
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend"><i class="bi bi-info-circle"></i></span>
                                                    <input type="password" id="password" class="form-control @error('password') is-invalid @elseif(old('password', $teacher->password ?? false)) is-valid @enderror" name="password" placeholder="Password">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    @else
                                                    @if(old('password', $teacher->password ?? false))
                                                    <div class="valid-feedback d-block">
                                                        <i class="bi bi-check-circle"></i>
                                                        Looks good!
                                                    </div>
                                ...
                                <div class="row d-flex align-items-center justify-content-center mt-4">
                                    ...
                                    <button type="submit" class="btn btn-outline-success w-25 ms-1">
                                        ...
                                        <span class="ms-1">{{ isset($teacher) ? 'Update' : 'Save' }}</span>
                                    </button>
                                </div>
                            </form>
